...
class ProgramController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('registrar.programs.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('registrar.programs.edit', $program)
    ...
    public function edit(Program $program): View
    {
        ...
        return view('registrar.programs.edit', compact('program', 'availableCourses'));
    }
    ...
    public function destroy(Program $program): RedirectResponse
    {
        ...
        return redirect()->route('registrar.programs.index')->with('success', 'ลบหลักสูตรแล้ว');
    }
