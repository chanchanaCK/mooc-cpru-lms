...
> สถานะปัจจุบัน: **เฟส 1–5 ใช้งานได้จริง** (เรียน · ซื้อขาย · สตูดิโอผู้สอน · แบบทดสอบ&ใบประกาศ · แผงแอดมิน)
...
> แอดมิน: ภาพรวมสถิติ → จัดการผู้ใช้/บทบาท → ดูแลคอร์ส → จัดการคูปอง (ที่ `/admin`)
